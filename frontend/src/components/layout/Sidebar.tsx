...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/debit-notes',               label: 'Purchase Returns', icon: Undo2,     roles: ['SUPER_ADMIN', 'BRANCH_MANAGER', 'PURCHASE_CHECKER', 'ACCOUNTS_PERSON'] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/history-photos',              label: 'History Photos',  icon: History,         roles: ['SUPER_ADMIN', 'BRANCH_MANAGER'] },
