...
export const metadata: Metadata = {
  title: 'About Srivani Stores — Sangareddy since 1980',
  description:
    'Order groceries, staples, oils, dals, masalas, dairy & household essentials online. Home delivery in Sangareddy. Sri Vani Kirana & General Stores — trusted since 1980.',
  alternates: { canonical: '/about' },
  openGraph: {
    title: 'About Srivani Stores — Sangareddy since 1980',
    description: 'The same Pure, Trust & Quality that families in Sangareddy have relied on since 1980.',
    url: '/about',
  },
};
...
const FAQ_LD = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: `Yes, Srivani Stores offers home delivery across Sangareddy, Telangana. Place your order at shop.srivani.com or WhatsApp ${STORE_WA_DISPLAY} and we will deliver to your doorstep. Store pickup is also available.`,
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: `You can order groceries from Srivani Stores online at shop.srivani.com, or on WhatsApp by messaging ${STORE_WA_DISPLAY}. We accept UPI, debit card, credit card and cash on delivery.`,
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Sri Vani Kirana & General Stores, Srivani Stores, Srivani Kirana, and Sri Vani Store are all the same shop — founded by Mr. M. Pandurangam in 1980 at New Bus Stand Area, Sangareddy, Telangana. It is one of the oldest and most trusted grocery stores in Sangareddy.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: `You can reach Srivani Stores Sangareddy by phone at ${STORE_CALL_DISPLAY} or WhatsApp at ${STORE_WA_DISPLAY}. Email: srivanistore.srd@gmail.com. Address: New Bus Stand Area, Sangareddy, Telangana 502001.`,
      },
    },
    {
      '@type': 'Question',
    ...
    <>
      <div className="wrap">
        ...
        <section className="hero">
            ...
            <div className="seal-wrap rv d3">
              <div className="seal">
                <svg className="ring" viewBox="0 0 230 230" aria-hidden="true" focusable="false" tabIndex={-1}>
                  ...
                  <text>
                    <textPath href="#ab-circle" startOffset="0" tabIndex={-1}>
          ...
          <div className="hero-copy">
            <p className="kicker rv d1">Forty-six years of trust</p>
            <h1 className="rv d2">
            ...
            <p className="lede rv d3">
              ...
              1980 — now at your fingertips, with home delivery and store pickup.
            </p>
            <div className="ctas rv d4">
              <a
                className="btn btn-pri"
                href={`https://wa.me/${STORE_WA_NUMBER}?text=Hello%20Sri%20Vani%20Stores%2C%20I%27d%20like%20to%20place%20an%20order.`}
                target="_blank"
              ...
              <a className="btn btn-ghost" href={`tel:+${STORE_CALL_NUMBER}`}>
                ...
                Call {STORE_CALL_DISPLAY.replace('+91 ', '')}
              </a>
            </div>
          </div>
        </section>
        ...
        <section className="sec">
          ...
          <div className="feat">
            ...
            <div className="card">
              ...
              <h3>Home delivery</h3>
              <p>Our doorstep tradition since 1980 — your order brought home, fresh and on time.</p>
            </div>
            <div className="card">
              <div className="ic">
      ...
      <section className="heritage">
        <div className="wrap">
          ...
          <h2>
            A Sangareddy landmark, started in 1980 with{' '}
          ...
          <div className="vals">
            <div className="val"><div className="n">1980</div><div className="l">Serving since</div></div>
          ...
          <div style={{ marginTop: '32px' }}>
            <div className="info-row">
              ...
              <div>
                ...
                {' · '}
                <a href={`https://wa.me/${STORE_WA_NUMBER}`} target="_blank" rel="noopener noreferrer">{STORE_WA_DISPLAY}</a>
              </div>
            </div>
            <div className="info-row">
              <span className="ic2">
